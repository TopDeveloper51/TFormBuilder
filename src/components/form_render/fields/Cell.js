...
const TextCell = ({data, rowIndex, colIndex, actionRule, element, role}) => {
...
const NumberCell = ({data, rowIndex, colIndex, actionRule, element, role}) => {
  const {colors, fonts} = useTheme();
  const {tableData, setTableData, cellWidth} = useContext(DataTableContext);
  const userRole = formStore(state => state.userRole);
  const preview = formStore(state => state.preview);
...
const DateCell = ({data, rowIndex, colIndex, actionRule, element, role}) => {
  const {colors, fonts} = useTheme();
  const {tableData, setTableData, cellWidth} = useContext(DataTableContext);
  const userRole = formStore(state => state.userRole);
  const preview = formStore(state => state.preview);
...
const TimeCell = ({data, rowIndex, colIndex, actionRule, element, role}) => {
  const {colors, fonts} = useTheme();
  const {tableData, setTableData, cellWidth} = useContext(DataTableContext);
  const userRole = formStore(state => state.userRole);
  const preview = formStore(state => state.preview);
...
const MenuCell = ({data, rowIndex, colIndex, header, actionRule, element, role}) => {
